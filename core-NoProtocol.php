...
function loadConfig(){
    if(!file_exists(__DIR__ . "/config.php")){
        ...
        exit("[" . date('Y-m-d H:i:s') . "][Main][Init][Info] Please configure your configration, then try again.\r\n[" . date('Y-m-d H:i:s') . "][Main][Init][Info] Exiting...\r\n");
    }
...
function onConnect($connection)
{
    ...
    if($conn==true) echo "[" . date('Y-m-d H:i:s') . "][worker:{$connection->proxyid}-{$connection->id}][uid:{$connection->uid}][Msgs:{$connection->msgid}][Info] Connected.\r\n";

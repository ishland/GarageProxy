...
class TcpConnection extends ConnectionInterface
{
    ...
    public function __construct($socket, $remote_address = '')
    {
        ...
        Worker::$globalEvent->add($this->_socket, EventInterface::EV_READ, array(
            $this,
            'baseRead'
        ));
    ...
    public function send($send_buffer, $raw = false)
    {
        ...
        if ($this->_sendBuffer === '') {
            ...
            Worker::$globalEvent->add($this->_socket, EventInterface::EV_WRITE, array(
                $this,
                'baseWrite'
            ));
    ...
    public function baseRead($socket, $check_eof = true)
    {
        ...
        if ($this->transport === 'ssl' && $this->_sslHandshakeCompleted !== true) {
            ...
            if ($this->_sendBuffer) {
                Worker::$globalEvent->add($socket, EventInterface::EV_WRITE, array(
                    $this,
                    'baseWrite'
                ));
            }

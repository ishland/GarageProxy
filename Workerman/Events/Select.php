...
class Select implements EventInterface
{
    ...
    {
        // Create a pipeline and put into the collection of the read to read the
        // descriptor to avoid empty polling.
    ...
    {
        call_user_func_array($this->_signalEvents[$signal][self::EV_SIGNAL][0],
                array(
                        $signal
                ));
    }
    ...
    protected function tick ()
    {
        while (! $this->_scheduler->isEmpty()) {
            ...
            if ($this->_selectTimeout <= 0) {
                ...
                if (isset($this->_eventTimer[$timer_id]) &&
                        $task_data[2] === self::EV_TIMER_ONCE) {

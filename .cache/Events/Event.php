    ...
    public function add ($fd, $flag, $func, $args = array())
    {
        switch ($flag) {
            ...
            case self::EV_TIMER_ONCE:
                ...
                $event = new \Event($this->_eventBase, - 1,
            ...
            default:
                $fd_key = (int) $fd;
                $real_flag = $flag === self::EV_READ ? \Event::READ |
                        \Event::PERSIST : \Event::WRITE | \Event::PERSIST;
                $event = new \Event($this->_eventBase, $fd, $real_flag, $func,
                        $fd);
                if (! $event || ! $event->add()) {
                    return false;
                }

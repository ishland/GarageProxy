...
class Worker
{
    ...
    protected static function displayUI ()
    {
        ...
        static::safeEcho(
                ...
                "<w>processes</w> <w>status</w>\n");
        foreach (static::$_workers as $worker) {
            static::safeEcho(
                    str_pad($worker->user, static::$_maxUserNameLength + 2) .
                    str_pad($worker->name, static::$_maxWorkerNameLength + 2) . str_pad(
    ...
    protected static function writeStatisticsToStatusFile ()
    {
        ...
        /** @var \Workerman\Worker $worker */
        $worker = current(static::$_workers);
        $worker_status_str = posix_getpid() . "\t" . str_pad(
                round(memory_get_usage(true) / (1024 * 1024), 2) . "M", 7) . " " .
